...
function PageContent() {
  ...
  const pricingRef = useViewPricing('63days-door')
  ...
  return (
    ...
    <main className="min-h-screen bg-white text-black font-sans">
      ...
      <section className="pt-20 pb-16 px-6 max-w-3xl mx-auto text-center">
        ...
        <div className="text-base text-gray-600 leading-relaxed space-y-2 max-w-md mx-auto mb-12">
      ...
      <section className="py-20 px-6 bg-gray-50">
        <div className="max-w-2xl mx-auto">
          ...
          <div className="text-center pt-10">
            <AnchorButton label="Δίνω στον εαυτό μου αυτό που χρειάζεται" />
          </div>
        </div>
      </section>
      ...
      <section className="py-20 px-6 bg-white">
        <div className="max-w-2xl mx-auto">
          ...
          <div className="space-y-3 max-w-md mx-auto mb-10">
            {[
              'Έχεις περιμένει χρόνια κάποιον να εμφανιστεί',
              'Θέλεις να σταματήσει η υπερανάλυση',
              'Θέλεις να βάζεις όρια',
              'Θέλεις πειθαρχία χωρίς πίεση',
              'Έχεις κουραστεί να ζητάς άδεια',
              'Είσαι έτοιμος να γίνεις δικός σου',
            ].map((item, i) => (
      ...
      <section id="apofasi" ref={pricingRef as RefObject<HTMLElement>} className="py-20 px-6 bg-gray-50 scroll-mt-8">
        <div className="max-w-xl mx-auto text-center">
          ...
          <div className="text-gray-700 leading-relaxed space-y-3 mb-12">
            ...
            <p className="text-lg font-semibold pt-2" style={{ fontFamily: 'Georgia, serif' }}>Τον εαυτό σου.</p>
          </div>
          <div id="waitlist">
            <ClosedProgramCTA source="63days-door" />
          </div>
        </div>
      </section>
