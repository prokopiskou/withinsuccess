...
2. Coaching 1-1 — η πιο δυνατή επένδυση που κάνει κάποιος στον εαυτό του. Δεν είναι απλώς συνεδρίες, είναι η δουλειά που αλλάζει τον τρόπο που βλέπει κανείς τον εαυτό του. Τρίμηνη δέσμευση, βιντεοκλήσεις 45'.
   Κάθε περίοδο δέχεται περιορισμένο αριθμό ατόμων. Περιορισμένες θέσεις. Βαθιά εξατομικευμένη δουλειά, όχι γενικές συμβουλές.
   START (1 συνεδρία/μήνα, €210): https://buy.stripe.com/7sYeVegnR7eZ6eR3cZ4ZG1J
   GROW (2 συνεδρίες/μήνα, €360): https://buy.stripe.com/eVq8wQ3B5bvf1YB5l74ZG1K
   EVOLVE (4 συνεδρίες/μήνα, €600): https://buy.stripe.com/7sY7sM5Jd0QB7iV7tf4ZG1L
   Ιδανικό για: βαθιά προσωπική δουλειά, κατεύθυνση, accountability.
   Όταν μιλάς για coaching: τόνισε την εξατομίκευση και τις περιορισμένες θέσεις. Δεν είναι για όλους. Είναι για ανθρώπους που θέλουν πραγματική αλλαγή.
