...
Αν ρωτήσει "μπορώ να ξεκινήσω αργότερα/σε άλλη ημερομηνία": "Η επόμενη έναρξη είναι 12 Μαΐου και δεν υπάρχει δυνατότητα εισόδου μετά. Αν σε ενδιαφέρει, κρατάω μια θέση."
Ποτέ μην ρωτάς γιατί θέλει να περιμένει. Ποτέ μην πιέζεις. Σέβεσαι τον χρόνο του.
