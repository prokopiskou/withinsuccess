...
function PageContent() {
  ...
  const pricingRef = useViewPricing('63days-paidi')
  ...
  return (
    ...
    <main className="min-h-screen bg-white text-black font-sans">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            ...
            <div className="bg-gray-50 rounded-2xl p-8">
              ...
              <div className="space-y-3 text-gray-600 text-sm">
                ...
                <div className="flex items-start gap-3"><span className="text-gray-500 mt-0.5">—</span><span>Χτίζεις συνέπεια, σπας τα παλιά μοτίβα, παίρνεις τον έλεγχο</span></div>
              </div>
            </div>
      ...
      {/* ΑΠΟΦΑΣΗ */}
      <section id="apofasi" ref={pricingRef as RefObject<HTMLElement>} className="py-20 px-6 bg-white scroll-mt-8">
        <div className="max-w-xl mx-auto text-center">
          ...
          <div id="waitlist">
            <ClosedProgramCTA source="63days-paidi" />
          </div>
        </div>
      </section>
