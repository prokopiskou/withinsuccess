  ...
  return (
    <div className="w-full">
      ...
      <div className="flex items-center justify-center gap-2 mt-6">
        {images.map((_, i) => (
          <button key={i} onClick={() => setCurrent(i)} aria-label={`Μαρτυρία ${i + 1}`} className="flex items-center justify-center min-h-[24px] min-w-[24px]"><span className={`block h-1.5 rounded-full transition-all ${i === current ? 'bg-black w-6' : 'bg-gray-300 w-1.5'}`} /></button>
        ))}
      </div>
    </div>
  )
...
function PageContent() {
  ...
  const pricingRef = useViewPricing('63days-overthinking')
  ...
  return (
    ...
    <main className="min-h-screen bg-white text-black font-sans">
      ...
      <section className="pt-20 pb-16 px-6 max-w-3xl mx-auto text-center">
        ...
        <h1 className="text-3xl md:text-5xl font-semibold leading-tight tracking-tight mb-4" style={{ fontFamily: 'Georgia, serif' }}>
          Σε 63 μέρες
        </h1>
        <p className="text-3xl md:text-5xl font-semibold leading-tight tracking-tight mb-12" style={{ fontFamily: 'Georgia, serif', color: GOLD }}>
          θα σκέφτεσαι λιγότερο<br />και θα κάνεις περισσότερα.
        </p>

        <div className="text-base md:text-lg text-gray-600 leading-relaxed space-y-3 max-w-md mx-auto mb-12">
          <p>Μία πράξη τη μέρα.</p>
          <p>1-2 λεπτά.</p>
          <p className="pt-2">Πριν προλάβει το μυαλό σου να αντισταθεί.</p>
        </div>

        <div className="text-lg md:text-xl text-gray-800 leading-relaxed space-y-2 max-w-md mx-auto mb-12 font-semibold" style={{ fontFamily: 'Georgia, serif' }}>
          <p>63 πράξεις.</p>
          <p>63 αποδείξεις στον εαυτό σου.</p>
        </div>
      ...
      <section className="py-20 px-6 bg-gray-50">
        <div className="max-w-2xl mx-auto">
          ...
          <div className="text-center pt-10">
            <AnchorButton label="Σπάω την υπερανάλυση" />
          </div>
        </div>
      </section>
        ...
        <div className="max-w-2xl mx-auto">
          ...
          <div className="bg-gradient-to-b from-gray-50 to-white rounded-2xl p-10 md:p-12 border border-gray-100">
            <div className="text-gray-700 leading-loose space-y-3 text-center text-lg">
              ...
              <p>Να μην ξεκινάς τη μέρα σου με 200 σκέψεις.</p>
              <p>Να μη γυρίζεις στο κρεβάτι αναλύοντας τι είπες.</p>
        ...
        <div className="max-w-2xl mx-auto">
          ...
          <div className="space-y-3 max-w-md mx-auto mb-10">
            {[
              ...
              'Αναλύεις κάθε σου κίνηση πριν την κάνεις',
              'Γυρνάς στο κρεβάτι αναλύοντας τη μέρα',
              'Έχεις διαβάσει 10 βιβλία αυτοβελτίωσης χωρίς αλλαγή',
              'Έχεις κουραστεί να ξεκινάς και να σταματάς',
              'Είσαι έτοιμος να βγεις από το μυαλό σου',
            ].map((item, i) => (
      ...
      <section id="apofasi" ref={pricingRef as RefObject<HTMLElement>} className="py-20 px-6 bg-gray-50 scroll-mt-8">
        <div className="max-w-xl mx-auto text-center">
          ...
          <h2 className="text-3xl md:text-4xl font-semibold mb-10 leading-tight" style={{ fontFamily: 'Georgia, serif' }}>
            Σταμάτα να σκέφτεσαι<br />αν θα το κάνεις.
          </h2>
      ...
      <section className="py-20 px-6 bg-gray-50">
        <div className="max-w-xl mx-auto text-center">
          <p className="text-2xl md:text-3xl font-semibold mb-4 leading-snug" style={{ fontFamily: 'Georgia, serif' }}>
            Το μυαλό σου δεν θα σου πει ποτέ ότι είναι η σωστή στιγμή.
          </p>
