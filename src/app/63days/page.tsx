  ...
  return (
    ...
    <main className="min-h-screen bg-white text-black font-sans">
      ...
      <section className="pt-16 pb-12 px-6 max-w-3xl mx-auto text-center">
        ...
        <h1 className="text-3xl md:text-5xl font-semibold leading-tight tracking-tight mb-10" style={{ fontFamily: 'Georgia, serif' }}>
          Δεν σου λείπει η θέληση.<br />
          <span className="text-gray-500">Σου λείπει ένα σύστημα να σε κρατάει σε πορεία.</span>
        </h1>
        <div className="text-lg text-gray-600 leading-relaxed space-y-3 mb-10 max-w-xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-6 max-w-2xl mx-auto mb-12">
          <div className="bg-white rounded-2xl p-6 border border-gray-100 shadow-sm text-left">
            <p className="text-xs tracking-widest text-gray-400 uppercase mb-4">Για 63 μέρες</p>
            <div className="space-y-3">
              {[
                'Ξέρεις τι πρέπει να κάνεις κάθε μέρα',
                'Ξέρεις γιατί το κάνεις',
                'Δεν έχεις χώρο να κρυφτείς από τον εαυτό σου'
              ].map((item, i) => (
          ...
          <div className="bg-white rounded-2xl p-6 border border-gray-100 shadow-sm text-left">
            <p className="text-xs tracking-widest text-gray-400 uppercase mb-4">Σε 63 μέρες αλλάζεις</p>
            <div className="space-y-3">
        ...
        <div className="inline-block bg-gray-50 rounded-2xl px-8 py-6">
