...
function sanitizeText(text) {
  ...
  return text
    ...
    .replace(/\s*[—–―]\s*/g, ', ').replace(/ - /g, ', ').replace(/^\uFEFF/, '');                  // BOM at start
}
...
BRAND VOICE (CRITICAL — strict adherence required):
- Γράφεις σε απλά, σωστά ελληνικά
- Έλεγξε ΓΡΑΜΜΑΤΙΚΗ: συμφωνία γένους/αριθμού/πτώσης σε κάθε πρόταση (πχ "οι ψεύτικες επιθυμίες" όχι "τα ψεύτικα επιθυμία")
- Έλεγξε χρήση "ότι" vs "ό,τι" (αν εννοεί "whatever" χρησιμοποίησε ό,τι με κόμμα)
- ΑΠΑΓΟΡΕΥΟΝΤΑΙ ΠΛΗΡΩΣ: μαλακίες, σκατά, γαμώτο, βλακείες, χάλια, και κάθε αργκό/χυδαία λέξη. Το brand είναι premium.
- ΑΠΑΓΟΡΕΥΟΝΤΑΙ: μεταφρασμένες αγγλικές εκφράσεις (πχ "τραβάς τον εαυτό σου από τα μαλλιά"). Χρησιμοποίησε αυθεντικές ελληνικές εκφράσεις.
- ΑΠΑΓΟΡΕΥΟΝΤΑΙ clichés αυτοβελτίωσης τύπου: "ψεύτικες επιθυμίες", "δύναμη θέλησης", "comfort zone", "βγες έξω από τη ζώνη άνεσης"
- Τόνος: άμεσος, σοβαρός, calm power. ΟΧΙ φιλικά κλισέ.
- Μικρές προτάσεις. Καθαρές. ΚΑΜΙΑ παύλα καθόλου (ούτε -, ούτε —, ούτε –). Χρησιμοποίησε κόμμα ή τελεία.
- Χρησιμοποίησε: "ταυτότητα", "εσωτερική ιστορία", "πραγματικός εαυτός" (όχι: "πειθαρχία", "συνέπεια")
- ΠΟΤΕ μην ξεκινάς πρόταση με "Είναι μαλακίες" ή παρόμοιες εκφράσεις
- ΠΟΤΕ generic παραδείγματα (μουσικός, αθλητής). Αν χρειαστείς παράδειγμα, κάν' το συγκεκριμένο και πιστευτό.
...
ΤΕΛΙΚΟΣ ΕΛΕΓΧΟΣ (υποχρεωτικός): ξαναδιάβασε ΟΛΟ το άρθρο και διόρθωσε γραμματική (συμφωνία γένους/αριθμού/πτώσης, υπαρκτά ρήματα), ορθογραφία, τονισμό, ότι/ό,τι. Καμία παύλα. Όλα τα εισαγωγικά σε «...». Κάθε απόδοση σε πρόσωπο ή γεγονός να είναι ακριβής, αλλιώς κάνε τη διατύπωση γενική. Επίστρεψε μόνο αφού το άρθρο είναι άψογο. ΕΠΕΣΤΡΕΨΕ ΤΗΝ ΑΠΑΝΤΗΣΗ ΣΟΥ ΣΕ ΑΥΤΗ ΤΗ ΜΟΡΦΗ (XML tags):
